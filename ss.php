...
<body>
  ...
  <table width="200" border="0">
    <tr>
      <td><label>Add Details:</label><input type="text" name="adddetails"  class="form-control" style="width:300px;"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><label>Staff id:</label><input type="text" name="staffid" value="" class="form-control" style="width:300px;" /></td>
    </tr>
    <tr>
